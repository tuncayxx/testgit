...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see dk.tuncay.service.impl.PasswordTokenManager#generateRecoveryToken(dk.tuncay.model.User)
     */
    @Override
    ...
    /**
     * @see dk.tuncay.service.impl.PasswordTokenManager#isRecoveryTokenValid(dk.tuncay.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see dk.tuncay.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
