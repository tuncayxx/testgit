package dk.tuncay.service.impl;

import org.apache.commons.lang.StringUtils;
import dk.tuncay.dao.UserDao;
import dk.tuncay.model.User;
import dk.tuncay.service.MailEngine;
import dk.tuncay.service.UserExistsException;
import dk.tuncay.service.UserManager;
import dk.tuncay.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "dk.tuncay.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see dk.tuncay.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
